  ...
  switch (type) {
    case 1:
      if (ele.src.includes('https://cn.gravatar.com/avatar')) {
        ele.src = ele.src.replace('https://cn.gravatar.com/avatar/', 'https://cdn.jsdelivr.net/gh/senxl/hexo-cdn/img/other/gravatar.jpg')
      } else {
        ele.src = 'https://cdn.jsdelivr.net/gh/senxl/hexo-cdn/img/other/default_avatar.jpg'
      }
      break
    case 2:
      ele.src = 'https://cdn.jsdelivr.net/gh/senxl/hexo-cdn/img/other/default_gavatar.png'
      break
    case 3:

      ele.src = 'https://cdn.jsdelivr.net/gh/senxl/hexo-cdn/img/other/image-404.png'
      break
    default:
      ele.src = 'https://cdn.jsdelivr.net/gh/senxl/hexo-cdn/img/other/image-404.png'
  }
...
function checkBgImgCookie () {
  ...
  if (bgurl != '') {
    if (bgurl == 'https://cdn.jsdelivr.net/gh/senxl/hexo-cdn/img/themebg/sakura.png' || bgurl == 'https://cdn.jsdelivr.net/gh/senxl/hexo-cdn/img/themebg/plaid.jpg' || bgurl == 'https://cdn.jsdelivr.net/gh/senxl/hexo-cdn/img/themebg/star.png' || bgurl == 'https://cdn.jsdelivr.net/gh/senxl/hexo-cdn/img/themebg/point.png' || bgurl == 'https://cdn.jsdelivr.net/gh/senxl/hexo-cdn/img/themebg/little-monster.png') {
...
$(document).ready(function () {
  ...
  $('.skin-menu #dark-bg').click(function () {
    mashiro_global.variables.skinSecter = true
    mashiro_global.variables.isNight = true
    $('body').css('background-image', 'url(https://cdn.jsdelivr.net/gh/senxl/hexo-cdn/img/other/starry_sky.png)')
